...
std::wstring Cipher::encrypt(const std::wstring& open_text)
{
    ...
    if (columns > len_text) {
        throw cipher_error("Key length should not exceed the length of the text to be encrypted");
    }
...
std::wstring Cipher::decrypt(const std::wstring& cipher_text)
{
    ...
    if (columns > len_text) {
        throw cipher_error("Key length should not exceed the length of the text to be decrypted");
    }
...
inline std::wstring Cipher::getValidOpenText(const 
std::wstring & ws_open_text)
{
    std::wstring tmp;
...
inline std::wstring Cipher::getValidCipherText(const 
std::wstring & ws_cipher_text)
{
