...
modAlphaCipher::modAlphaCipher(std::wstring & ws_key)
{
	pillar = getValidKey(ws_key);
}
void modAlphaCipher::set_key(std::wstring & ws_key)
{
	pillar = getValidKey(ws_key);
}
...
inline int modAlphaCipher::getValidKey(std::wstring & ws_key)
{
	if (ws_key.empty())
...
inline std::wstring modAlphaCipher::getValidOpenText(const std::wstring & ws_open_text)
{
	std::wstring tmp;
...
inline std::wstring modAlphaCipher::getValidCipherText(const std::wstring & ws_cipher_text)
{
